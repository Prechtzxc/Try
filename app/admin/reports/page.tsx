    ...
    <PermissionGuard permission="reports">
          ...
          <Tabs value={activeTab} className="space-y-6" onValueChange={setActiveTab}>
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="flex justify-between items-center mb-2">
                ...
                <Button onClick={() => setTimeout(() => window.print(), 300)} className="bg-slate-900 hover:bg-slate-800 text-white rounded-xl h-10 px-5 font-bold text-xs shadow-md gap-2">
                  <Printer className="h-4 w-4" /> Print Report
                </Button>
              </div>

              <div id={`pdf-charts-export-Active_Cycle`} className="print-report-section bg-slate-50/50 p-4 sm:p-6 lg:p-8 rounded-3xl w-full mx-auto max-w-[1100px]">
                
                <div className="print-only hidden text-center mb-8 border-b border-slate-300 pb-6">
                  <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight">BTS Scholarship Management System</h1>
                  <h2 className="text-xl font-bold text-emerald-700 mt-1 uppercase tracking-wide">Reports &amp; Analytics</h2>
                  <p className="text-lg font-semibold text-slate-700 mt-2">Overview Report</p>
                  <div className="flex items-center justify-center gap-4 mt-3 text-sm text-slate-500">
                    <span>Cycle: <strong className="text-slate-800">Active Cycle</strong></span>
                    <span>Generated: <strong className="text-slate-800">{new Date().toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" })} • {new Date().toLocaleTimeString("en-US", { hour: "numeric", minute: "2-digit" })}</strong></span>
                    <span>Generated by: <strong className="text-slate-800">Administrator</strong></span>
                  </div>
                </div>
            ...
            <TabsContent value="demographics" className="space-y-6">
              ...
              <div className="print-report-section">
                <div className="print-only hidden text-center mb-8 border-b border-slate-300 pb-6">
                  <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight">BTS Scholarship Management System</h1>
                  <h2 className="text-xl font-bold text-emerald-700 mt-1 uppercase tracking-wide">Reports &amp; Analytics</h2>
                  <p className="text-lg font-semibold text-slate-700 mt-2">Demographics Report</p>
                  <div className="flex items-center justify-center gap-4 mt-3 text-sm text-slate-500">
                    <span>Cycle: <strong className="text-slate-800">Active Cycle</strong></span>
                    <span>Generated: <strong className="text-slate-800">{new Date().toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" })} • {new Date().toLocaleTimeString("en-US", { hour: "numeric", minute: "2-digit" })}</strong></span>
                    <span>Generated by: <strong className="text-slate-800">Administrator</strong></span>
            ...
            <TabsContent value="academic" className="space-y-6">
              ...
              <div className="print-report-section">
                <div className="print-only hidden text-center mb-8 border-b border-slate-300 pb-6">
                  <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight">BTS Scholarship Management System</h1>
                  <h2 className="text-xl font-bold text-emerald-700 mt-1 uppercase tracking-wide">Reports &amp; Analytics</h2>
                  <p className="text-lg font-semibold text-slate-700 mt-2">Academic Report</p>
                  <div className="flex items-center justify-center gap-4 mt-3 text-sm text-slate-500">
                    <span>Cycle: <strong className="text-slate-800">Active Cycle</strong></span>
                    <span>Generated: <strong className="text-slate-800">{new Date().toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" })} • {new Date().toLocaleTimeString("en-US", { hour: "numeric", minute: "2-digit" })}</strong></span>
                    <span>Generated by: <strong className="text-slate-800">Administrator</strong></span>
              ...
              <Card className="rounded-3xl border-slate-200 shadow-sm overflow-hidden bg-white">
                ...
                <CardHeader className="bg-slate-50/50 border-b border-slate-100 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    ...
                    <Button onClick={() => setTimeout(() => window.print(), 300)} className="sm:hidden bg-slate-900 hover:bg-slate-800 text-white rounded-xl h-9 px-4 font-bold text-xs shadow-md gap-2 mt-3">
                  ...
                  <div className="flex items-center gap-3 w-full sm:w-auto bg-white p-2 rounded-2xl border border-slate-200 shadow-sm">
                    <Button onClick={() => setTimeout(() => window.print(), 300)} className="hidden sm:flex bg-slate-900 hover:bg-slate-800 text-white rounded-xl h-9 px-4 font-bold text-xs shadow-md gap-2">
                      <Printer className="h-3.5 w-3.5" /> Print Report
                    </Button>
                                ...
                                {isExpanded && (
                                  <TableRow className="bg-slate-50/50 hover:bg-slate-50/50 border-b border-emerald-100">
                                    <TableCell colSpan={6} className="p-0 border-b-0 w-full">
                                      <div className="print-report-section p-4 sm:p-6 lg:p-8 animate-in slide-in-from-top-2 duration-300 w-full">
                                        ...
                                        <div id={`pdf-charts-export-${cycle.replace(/\s+/g, '-')}`} className="bg-slate-50/50 p-4 sm:p-6 lg:p-8 rounded-3xl w-full mx-auto max-w-[1100px]">
                                          ...
                                          <div className="print-only hidden text-center mb-8 border-b border-slate-300 pb-6">
                                            <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tight">BTS Scholarship Management System</h1>
                                            <h2 className="text-xl font-bold text-emerald-700 mt-1 uppercase tracking-wide">Reports &amp; Analytics</h2>
                                            <p className="text-lg font-semibold text-slate-700 mt-2">History Archives Report</p>
                                            <p className="text-sm font-medium text-slate-500 mt-1">{cycle}</p>
                                            <div className="flex items-center justify-center gap-4 mt-3 text-sm text-slate-500">
                                              <span>Cycle: <strong className="text-slate-800">{cycle}</strong></span>
                                              <span>Generated: <strong className="text-slate-800">{new Date().toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" })} • {new Date().toLocaleTimeString("en-US", { hour: "numeric", minute: "2-digit" })}</strong></span>
                                              <span>Generated by: <strong className="text-slate-800">Administrator</strong></span>
                                            </div>
                                          </div>
      ...
      <style>{`
        @media print {
          ...
          .print-report-section, .print-report-section * { visibility: visible !important; }
          .print-report-section { position: absolute; left: 0; top: 0; width: 100%; background: white; padding: 40px; z-index: 999999; }
